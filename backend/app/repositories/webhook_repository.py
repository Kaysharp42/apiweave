...
class WebhookRepository:
    ...
    @staticmethod
    async def get_by_id(webhook_id: str) -> Optional[Webhook]:
        """
    ...
    @staticmethod
    async def get_by_token(token: str) -> Optional[Webhook]:
        """
    ...
    async def get_by_resource(resource_type: str, resource_id: str) -> List[Webhook]:
        ...
        return await Webhook.find(
            Webhook.resourceType == resource_type,
    ...
    async def get_by_environment(environment_id: str) -> List[Webhook]:
        ...
        """
        return await Webhook.find(
            Webhook.environmentId == environment_id
        ).to_list()
    
    @staticmethod
    async def update(webhook_id: str, update_data: dict) -> Optional[Webhook]:
        """
    ...
    @staticmethod
    async def update_usage(webhook_id: str, status: str) -> Optional[Webhook]:
        """
