...
class RunRepository:
    ...
    @staticmethod
    async def update_status(run_id: str, status: str, error: str | None = None) -> Run | None:
        """Update run status"""
    ...
    @staticmethod
    async def add_result(run_id: str, result: RunResult) -> Run | None:
    ...
    @staticmethod
    async def update_results(run_id: str, results: list[RunResult]) -> Run | None:
    ...
    @staticmethod
    async def get_latest_failed_run(workflow_id: str) -> Run | None:
    ...
    @staticmethod
    async def get_latest_run(workflow_id: str) -> Run | None:
    ...
    @staticmethod
    async def count_by_status(workflow_id: str | None = None) -> dict[str, int]:
    ...
    @staticmethod
    async def update_fields(run_id: str, **fields) -> Run | None:
