...
class CollectionRepository:
    ...
    @staticmethod
    async def get_by_id(collection_id: str) -> Collection | None:
    ...
    @staticmethod
    async def update(collection_id: str, update_data: CollectionUpdate) -> Collection | None:
    ...
    @staticmethod
    async def update_workflow_count(collection_id: str, count: int) -> Collection | None:
    ...
    @staticmethod
    async def increment_workflow_count(collection_id: str) -> Collection | None:
    ...
    @staticmethod
    async def decrement_workflow_count(collection_id: str) -> Collection | None:
    ...
    async def search_by_name(search_term: str, limit: int = 10) -> list[Collection]:
        ...
        return (
            await Collection.find({"name": {"$regex": search_term, "$options": "i"}})
            .limit(limit)
            .to_list()
        )
