...
async def check_webhook_rate_limit(webhook_id: str, max_requests_per_hour: int = 100) -> None:
    """
...
def get_rate_limit_headers(webhook_id: str, max_requests_per_hour: int = 100) -> dict:
    """
