        ...
        if log_has_resolved:
            results.append(
                (
                    ...
                    True,
                    "Log contains 'Resolved variable as file path' "
                    "with win.ini — file read confirmed",
                )
            )
        else:
            results.append(
                (
                    "File read vulnerable (file was read)",
                    False,
                    "Expected log to show resolved file path but it did not "
                    "— file read may be blocked",
                )
            )
