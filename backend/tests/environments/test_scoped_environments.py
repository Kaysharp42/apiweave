...
class TestOrgEnvironmentPolicy:
    ...
    async def test_list_org_envs_for_workspace_filters(self):
        ...
        with (
            patch.object(ScopedEnvironmentRepository, "list_by_scope", new_callable=AsyncMock),
            patch.object(
...
class TestScopedEnvironmentCRUD:
    ...
    async def test_update_scoped_environment(self):
        ...
        _make_env(env_id="env-test", name="Old Name", scope_type="workspace", scope_id="ws-test")
        updated = _make_env(
