...
const KEEP: Record<string, readonly [Method, Entry][]> = {
  "workspaces.py": [
    ...
    ["GET", { path: "/{workspace_id}/projects", handler: "collections.list" }],
    ["POST", { path: "/{workspace_id}/projects", handler: "collections.create" }],
    ["GET", { path: "/{workspace_id}/projects/{project_id}", handler: "collections.get" }],
    ["PATCH", { path: "/{workspace_id}/projects/{project_id}", handler: "collections.update" }],
    ["DELETE", { path: "/{workspace_id}/projects/{project_id}", handler: "collections.delete" }],
    ["POST", { path: "/{workspace_id}/projects/{project_id}/workflows/{workflow_id}/assign", handler: "collections.addWorkflow" }],
    ["DELETE", { path: "/{workspace_id}/projects/{project_id}/workflows/{workflow_id}", handler: "collections.removeWorkflow" }],
  ...
  "projects.py": [
    ...
    ["GET", { path: "/healthz", gap: GAP_INFRA }],
    ["GET", { path: "/{project_id}", handler: "collections.get" }],
  ],
  "keys.py": [
