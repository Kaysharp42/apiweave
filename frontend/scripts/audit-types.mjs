 ...
 * 1. No type/interface/type-alias declarations outside frontend/src/types/
 * 2. At most ONE type/interface/type-alias declaration per file inside frontend/src/types/
