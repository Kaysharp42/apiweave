...
for (const vp of VIEWPORTS) {
  test.describe(`/login at ${vp.name}px width`, () => {
    ...
    test('renders login page and captures light-theme screenshot', async ({ page }) => {
    ...
    test('toggles theme and captures dark-theme screenshot', async ({ page }) => {
      await page.goto('/login');
      await page.waitForLoadState('networkidle');
...
for (const vp of VIEWPORTS) {
  test.describe(`/setup at ${vp.name}px width`, () => {
    ...
    test('renders setup page and captures light-theme screenshot', async ({ page }) => {
