...
describe("Task 11: Import panels and Swagger refresh migration", () => {
  describe("apiweaveClient URL builders for import/export", () => {
    ...
    it("workflowImportOpenapiRemoteUrl builds full URL with query params", () => {
      const url = workflowImportOpenapiRemoteUrl(
        "ws-1",
        "https://example.com/swagger.json",
        true,
      );
      expect(url).toContain(
        "/api/workspaces/ws-1/workflows/import/openapi/url",
      );
      expect(url).toContain(
        "swagger_url=https%3A%2F%2Fexample.com%2Fswagger.json",
      );
    ...
    it("workflowImportUrl builds scoped import URL", () => {
      ...
      expect(url).toBe(`${API_BASE_URL}/api/workspaces/ws-1/workflows/import`);
    });
