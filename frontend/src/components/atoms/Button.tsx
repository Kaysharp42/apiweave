  ...
  const getVariantClasses = (): string => {
    if (variant === 'primary') {
      const intentMap: Record<NonNullable<ButtonProps['intent']>, string> = {
        ...
        success: 'bg-status-success dark:bg-[var(--aw-status-success)] text-white dark:text-surface-dark border border-status-success dark:border-[var(--aw-status-success)] hover:brightness-95 dark:hover:brightness-105 shadow-raised hover:shadow-overlay',
        error: 'bg-status-error dark:bg-[var(--aw-status-error)] text-white dark:text-surface-dark border border-status-error dark:border-[var(--aw-status-error)] hover:brightness-95 dark:hover:brightness-105 shadow-raised hover:shadow-overlay',
        warning: 'bg-status-warning dark:bg-[var(--aw-status-warning)] text-white dark:text-surface-dark border border-status-warning dark:border-[var(--aw-status-warning)] hover:brightness-95 dark:hover:brightness-105 shadow-raised hover:shadow-overlay',
    ...
    if (variant === 'outline') {
      const intentMap: Record<NonNullable<ButtonProps['intent']>, string> = {
        default: 'bg-surface-raised dark:bg-surface-dark-raised text-text-primary dark:text-text-primary-dark border border-border dark:border-border-dark hover:bg-text-primary dark:hover:bg-text-primary-dark hover:text-surface-raised dark:hover:text-surface-dark hover:border-text-primary dark:hover:border-text-primary-dark',
        success: 'bg-surface-raised dark:bg-surface-dark-raised text-status-success dark:text-[var(--aw-status-success)] border border-status-success/40 dark:border-[var(--aw-status-success)]/40 hover:bg-status-success/10 dark:hover:bg-[var(--aw-status-success)]/10',
        error: 'bg-surface-raised dark:bg-surface-dark-raised text-status-error dark:text-[var(--aw-status-error)] border border-status-error/40 dark:border-[var(--aw-status-error)]/40 hover:bg-status-error/10 dark:hover:bg-[var(--aw-status-error)]/10',
        warning: 'bg-surface-raised dark:bg-surface-dark-raised text-status-warning dark:text-[var(--aw-status-warning)] border border-status-warning/40 dark:border-[var(--aw-status-warning)]/40 hover:bg-status-warning/10 dark:hover:bg-[var(--aw-status-warning)]/10',
