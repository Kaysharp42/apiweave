...
export function ProtectionSummary({
  ...
  if (!protection) {
    return (
      <div
        className={`flex items-center gap-3 p-3 rounded border border-border dark:border-border-dark bg-surface-overlay dark:bg-surface-dark-overlay ${className}`}
      >
  ...
  return (
    <div
      className={`p-3 rounded border border-border dark:border-border-dark bg-surface-raised dark:bg-surface-dark-raised space-y-3 ${className}`}
    >
      {/* Header */}
