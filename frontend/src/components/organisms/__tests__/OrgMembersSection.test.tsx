...
describe("OrgMembersSection", () => {
  ...
  it("shows loading spinner initially", () => {
    ...
    render(
      <OrgMembersSection orgSlug="acme" orgId="org-1" currentUserId="user-1" />,
    );
  ...
  it('shows "(you)" indicator for current user', async () => {
    const members = [makeMember({ userId: "user-1aaaaaaa", role: "owner" })];
    mockAuthenticatedJson.mockResolvedValue(members);
