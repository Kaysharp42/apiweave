...
function makeProtection(
  overrides: Partial<EnvironmentProtectionPolicy> = {},
...
describe("EnvironmentProtectionPanel", () => {
  ...
  function renderPanel(
    overrides: Partial<EnvironmentProtectionPanelProps> = {},
  ) {
  ...
  it("shows bypass allowlist when policy is trusted_token_only", () => {
    ...
    expect(
      screen.getByText("No tokens in allowlist. Add service token IDs below."),
    ).toBeInTheDocument();
  });
