    ...
    return (
      <div
        className={[
          ...
          text &&
            "bg-transparent text-xs text-text-muted dark:text-text-muted-dark before:h-full before:w-px before:bg-border dark:before:bg-border-dark after:h-full after:w-px after:bg-border dark:after:bg-border-dark",
          className,
        ]
          .filter(Boolean)
          .join(" ")}
      ...
      >
        {text && (
          <span className="px-1 font-mono text-[10px] uppercase tracking-wide">
            {text}
          </span>
        )}
      </div>
