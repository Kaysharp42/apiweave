...
export const resolveIconButtonSizeClass = (size: ButtonSize): string =>
  SIZE_CLASS_MAP[size] || SIZE_CLASS_MAP.sm;

export const resolveIconButtonVariantClass = (
  variant: IconButtonVariant,
): string => VARIANT_CLASS_MAP[variant] || VARIANT_CLASS_MAP.ghost;
